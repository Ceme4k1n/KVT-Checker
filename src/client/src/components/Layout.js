...
import { Menu as MenuIcon, Dashboard as DashboardIcon, Sensors as SensorsIcon, Settings as SettingsIcon, Assessment as LogsIcon } from '@mui/icons-material'
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
            КВТ - Комплект измерения температуры и влажности
          </Typography>
        </Toolbar>
      </AppBar>
